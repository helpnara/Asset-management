...
@objc(Plan)
class Plan: NSManagedObject, Identifiable {
    ...
    override func awakeFromInsert() {
        ...
        retirementYear = Calendar.current.component(.year, from: .now) + 23
        horizonYear = Calendar.current.component(.year, from: .now) + 23 + 35
        createdAt = Date.now
    }
}
