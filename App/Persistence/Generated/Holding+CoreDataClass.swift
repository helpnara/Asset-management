...
@objc(Holding)
class Holding: NSManagedObject, Identifiable {
    ...
    override func awakeFromInsert() {
        ...
        id = UUID()
        assetClassRaw = AssetClass.equity.rawValue
        instrumentTypeRaw = InstrumentType.stock.rawValue
        statusRaw = HoldingStatus.accumulating.rawValue
        cadenceRaw = EntryCadence.weekly.rawValue
        createdAt = Date.now
    }
}
