...
enum Persistence {
    ...
    static var schema: Schema {
        Schema([Member.self, Account.self, Holding.self, ReviewSession.self, Snapshot.self, SnapshotLine.self, Plan.self, CashEvent.self, IncomeStream.self, UserMilestone.self, TodoItem.self, Scenario.self])
    }
