...
struct PlanView: View {
        ...
        return Form {
            ...
            Section {
                ...
                if plan.autoTargetAmount == nil {
                    ...
                    Text("은퇴 뒤 한 해에 쓸 돈을 인출률로 나눈 값입니다. 쓸 돈은 아래 은퇴 이후 에서 넣고, 인출률은 더보기 → 자산 진단 → 진단 기준에서 정합니다. 세금을 빼기 전 금액입니다.")
                }
            }
            ...
            Section {
                ...
                Text("수정할 때마다 자동으로 기록됩니다. 1페이지에 들어가는 제목·기준 시점·맨 밑 한 줄은 더보기 → 내보내기 → 1페이지 문서 설정에서 고칩니다.")
            }
        }
    ...
    private func retirementSection(_ plan: Plan) -> some View {
        ...
        return Section {
            ...
            Text("여기 넣은 돈으로 은퇴 목표 금액이 정해지고, 궤적의 인출 구간도 이만큼씩 꺼내 씁니다. 셋 다 0이면 은퇴 시점에서 궤적이 끝납니다. 오늘 돈 기준으로 적으세요 — 물가는 앱이 태웁니다.\n\n연 취미 · 여행과 연 병원비는 해마다 한 번 나가는 돈입니다. 열두 달로 나눠 매달 꺼내는 것으로 봅니다.\n\n여기 금액과 은퇴 목표 금액은 세금을 빼기 전입니다. 연금저축 · IRP 에서 꺼낼 때 연금소득세가, 은퇴 뒤에는 건강보험료가 더 나갑니다. 인출률을 조금 낮춰 잡으면(4% → 3.5%) 그 몫이 자연스럽게 얹힙니다.")
        }
    }
